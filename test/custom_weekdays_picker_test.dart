...
void main() {
  group('Custom Weekdays Picker Tests in CreateReminderSheet', () {
    testWidgets(
      'Tapping Bestimmte Tage displays weekday buttons and quick selectors',
      (tester) async {
        await tester.pumpWidget(
          ProviderScope(
            child: MaterialApp(
              ...
              home: const Scaffold(body: CreateReminderSheet()),
            ),
          ),
        );
    ...
    testWidgets(
      'Pre-fills custom weekdays when editing an existing multi-day reminder',
      (tester) async {
        ...
        expect(
          find.bySemanticsLabel(RegExp(r'Montag, selected')),
          findsOneWidget,
        );
        expect(
          find.bySemanticsLabel(RegExp(r'Donnerstag, selected')),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets('Quick select Sa - So selects weekend days', (tester) async {
      ...
      expect(
        find.bySemanticsLabel(RegExp(r'Samstag, selected')),
        findsOneWidget,
      );
      expect(
        find.bySemanticsLabel(RegExp(r'Sonntag, selected')),
        findsOneWidget,
      );
    });
  });
