    ...
    try {
      ...
      _hivemindsSub = FirebaseFirestore.instance
          ...
          .listen(
            ...
            onError: (err) {
              debugPrint(
                'RealtimeReminderService hiveminds stream error: $err',
              );
            },
          );
    } catch (e) {
  ...
  static void _updateRemindersSubscription(
    ...
    _remindersSub = FirebaseFirestore.instance
        ...
        .listen(
          ...
          onError: (error) {
            debugPrint(
              'RealtimeReminderService reminders stream error: $error',
            );
          },
        );
  }
